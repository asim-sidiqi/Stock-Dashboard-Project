...
import {XIcon, SearchIcon, ChevronDoubleLeftIcon} from '@heroicons/react/solid';
...
export const Search = () => { 
  ...
  return (
    ...
    <div className={`flex items-center my-4 border-2 rounded-md relative z-50 w-96 
        ...
        className="h-8 w-8 bg-indigo-600 rounded-md flex justify-center items-center m-1 p-2 transition duration-100 hover:ring-2 ring-indigo-400">
